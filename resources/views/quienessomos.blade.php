...
<main>
  ...
  <section>
    ...
    <a class="uk-margin-small-right uk-icon-button" href="#" uk-slidenav-previous uk-icon="arrow-right"></a>

    <a class="uk-margin-small-right uk-icon-button" href="#" uk-slidenav-next uk-icon="arrow-left"></a>
