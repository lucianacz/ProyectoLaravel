...
<main>
  <section class="qSomos">
    ...
    <div class="col-lg-9 col-md-10 col-12">
      <h4 style="color:grey; margin-top:20px;">“Nunca dudes en irte lejos, más allá de todos los mares, de todas las fronteras, de todos los países, de todas las creencias”.
</h4>
        <p style="white-space: pre-wrap; justify-content:flex-start;">
          Viajar nos transforma.
          El viaje nos incomoda, nos desafía e interpela sacándonos de nuestra “zona de confort” para llevarnos a un estado tanto físico como mental elevado. Aqui nuestros sentidos se potencian, cada nuevo estímulo cambiará para siempre nuestra forma de percibir el mundo. Cada nuevo sabor, olor y color nos hacen reinterpretar lo que antes percibimos como delicioso o repugnante, como bello u horrible. Es así cómo nos nutrimos, crecemos y nos expandimos incorporando lo vivido.
