...
<head>
    <title>PAKISTAN x Cultura Sariri</title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no" />
    <link rel='stylesheet' id='fontawesome-css' href='https://use.fontawesome.com/releases/v5.0.1/css/all.css?ver=4.9.1' type='text/css' media='all' />
    <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
    <link href="https://fonts.googleapis.com/css2?family=Lato:wght@300;400;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="css/viajes3.css">
...
<body class="landing">
    ...
    <div id="page-wrapper">
        ...
        <section id="banner">
            ...
            <div class="inner">
                <h2>VIAJA A PAKISTAN</h2>
                <p>Reinos perdidos del Himalaya</p>
        ...
        <section id="one" class="wrapper style1 special">
            <div class="inner">
                <header class="major">
                    <h2>Anímate a explorar uno de los países más enigmaticos y menos explorados del subcontinente indio. Compartiremos con minorías etnicas de los Himalayas.
                    </h2>
