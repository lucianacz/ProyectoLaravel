...
<main>
  ...
  <div class="col-12" style="padding-top:5px;">
    ...
    <input id="files" class="form-control @error('foto') is-invalid @enderror" name="foto" style="display: none; visibility: hidden;" type="file">
    </span>
    @error('foto')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
  ...
  <div class="col-12" style="padding-top:5px;">
    ...
    <span class="uk-icon-button  uk-margin-small-right" uk-icon="camera">
    <input id="files" class="form-control @error('foto2') is-invalid @enderror" name="foto2" style="display: none; visibility: hidden;" type="file">
    </span>
    @error('foto2')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
